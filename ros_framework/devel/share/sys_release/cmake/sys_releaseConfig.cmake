...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sys_release' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/und-robotics/lunabotics23/ros_framework/src/sys_release/${idir}'.  ${_report}")
    endif()
